...
#Next, we modified the R_ETL.R file and use it to create two table on SQL server. The modified versions are as follows:
...
##First Plot: This is a scatterplot, and we are going to use Alaska Oil Well dataset to plot it.
![](Alaska_OilWell_Scatterplot.png) 
  
##Second Plot: This is a crosstab, and we are going to use Baltimore Annual Salaries dataset to plot it.
![](Baltimore_Salaries_Crosstab.png) 
  
##Third Plot: This is a bar chart, and we are going to use Alaska Oil Well dataset to plot it.
