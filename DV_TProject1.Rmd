...
We modified the R_ETL.R file and use it to create a table on SQL server. The modified version is as follows:
...
Here is the data frame built from calling ALASKA_OILWELL data from SQL server, and its summary and subset
